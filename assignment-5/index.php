...
<body class="bg-light">
    ...
    <div class="d-flex justify-content-center mt-4">
        <a href="./c.php" type="button" class="btn btn-primary"><i class="bi bi-plus-square me-2"></i>
            Add few tasks </a>
    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title text-uppercase fs-5" id="exampleModalLabel">Add few tasks</h1>
            ...
            while($row = $result -> fetch_assoc()) {
                echo "
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-primary btn-sm' href='edit.php?id=$row[serial]'>Edit</a>
                                <a class='btn btn-danger btn-sm' href='delete.php?id=$row[serial]'>Delete</a>
                            </td>
                        </tr>
                    ";
            }
